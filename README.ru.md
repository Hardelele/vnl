...
обе строки сделали бы буквально одно и то же. Обратной дороги — «положить тип
проекта в каталог, чтобы он был доступен другим проектам» — пока нет; она
отколота задачей #567, потому что каталожной записи нужны имя и объяснение,
которых у типа из паттерна нет, а значит это форма, а не кнопка.
