...
/**
 * Почему песочница закрыта -- одной строкой на всё приложение.
 *
 * Лежит здесь, рядом с `canChange` и `goToLogin`, а не в экране: про это
 * говорят в двух местах -- вкладка «Песочница» в панели сверху и кнопка «В
 * песочницу» на карточке паттерна (#526), -- и две формулировки одного
 * запрета читались бы как два разных запрета.
 */
export const SANDBOX_LOCKED =
  'Песочница открыта после входа: это чужая работа, а не витрина'
