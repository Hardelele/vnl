...
- 66 тестов, зависимостей у ядра нет.
...
- Нет инспектора одного нейрона (входы, баланс возбуждения и торможения,
  отклик после спайка каждого входа). Данные для него уже есть: `g_exc`
  и `g_inh` пишутся раздельно.
