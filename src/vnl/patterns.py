...
Уровень каталога (L1 «Клетки и связи», L2 «Микросхемы», L3 «Сети») -- про
масштаб конструкции. Уровень детализации симулятора в `RunSpec.level` -- про
физику. Совпадение обозначений случайно, и смешивать их нельзя.
"""
