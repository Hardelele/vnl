...
:root {
  ...
  --exc: #2e7d57;
  --inh: #c24039;
  /* шунт -- не третий оттенок торможения, а другая операция: он делит вход, а
     не вычитает из него. Поэтому и цвет свой, холодный: красным он читался бы
     как «слабое торможение», а на мембране его не видно вовсе (#496). */
  --shunt: #5b6b96;
  --mod: #b47318;
  --trace: var(--accent);
